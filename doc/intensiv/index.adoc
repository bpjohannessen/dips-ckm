...
* https://helse-bergen.no/seksjon/intensivregister/Documents/MRS%20-%20reg.%20av%20int.opphold%20i%20NIR/Kodebok%20MRS4%20.pdf[Kodebok]
...
Gjelder ikke for pasienter som kommer til intensiv for å dø.
|
...
link:NIR_ReasonAdmitted.txt[]

[source]
----
include::NIR_ReasonAdmitted.txt[]
----

=== Sekundærårsak (ett valg – frivillig)
Her benyttes samme kodeverk som for primærårsak
...
SOFA (Sequential Organ Failure Assessment)  er en skår for dysfunksjon/svikt i seks ulike organsystemer hos voksne (> 16 år) intensivpasienter. Skåringen gjøres en gang i døgnet, på et fast tidspunkt (f. eks. kl. 07 eller 08), og skal gjøres med utgangspunkt i de mest avvikende verdiene de foregående 24 timer.
...
Skåringen kan benyttes på en rekke måter: 

* Som individuelle skåringer for hvert organ for å bestemme utviklingen av dysfunksjon i organ
* Som en sum av skåringer på en intensiv dag 
* Som en sum av de verste skoringene i løpet av intensiv oppholdet 

Det antas å gi bedre stratifisering av dødelighetsrisikoen hos pasientene ved intensiv gitt at dataene som brukes til å beregne poengsummen ikke er begrenset til verdier fra innleggelsen. 


.Tabellarisk fremstilling av SOFA score 
...
.Mindmap for SOFA arketype
image::sofa_score_mindmap.png[]


.Eksempel på skjema for SOFA score
...
|Bruk 
a|Observasjonene som registreres skal være gjort ved eller omkring tidspunktet for første møte ansikt til ansikt, dvs. ikke telefonisk, mellom pasienten og en lege fra intensivenheten eller en lege fra et spesialisert barnetransportteam.
...
== Regler 
Det er en rekke regler som benyttes for scoringer og beregninger. I dette avsnittet beskrives noen av disse. 

=== GDL 

* https://gdl-lang.org/[GDL Lang Org]

==== SOFA

* https://github.com/gdl-lang/common-clinical-models/blob/master/guidelines/SOFA.v1.gdl[SOFA.v1.gdl]
* https://github.com/gdl-lang/common-clinical-models/blob/master/guidelines/SOFA_Interpretation.v1.gdl[SOFA_Interpretation.v1.gdl]

.Skjermbilde fra definisjonen av SOFA.v1 GDL score
image::gdl_sofa_definitions.png[]



== Vedlegg: Overflytning 
Følgende koder benyttes i NIR for å registrere hvilke intensivenheter som pasienten overføres til. 

[source]
----
include::Nir_Foretak_Overflytning.txt[]
----
